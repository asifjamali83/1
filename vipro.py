...
vipro = LINETCR.LINE()
#vipro.login(qr=True)
vipro.login(token='EAHiaoPnmnea5WX8MBU2.U2/HiZXWViJlVsQuLhuamG.hVInal8sSgf4tHxufNwFIKBbWRFEW1wfYyFc8EqVAIM=')
vipro.loginResult()
...
Bots=[mid]
Creator=["ubb6fa1233c70bc88cbbd2a9494750032"]
admin=["ubb6fa1233c70bc88cbbd2a9494750032"]
