    ...
    try:
        ...
        if op.type == 13:
            if op.param3 in wait["blacklist"]:
                if op.param3 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    wait["blacklist"][op.param2] = True
                    try:
                        group = random.choice(ABC).getGroup(op.param1)
                        gMembMids = [contact.mid for contact in group.invitee]
                ...
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    ...
                    try:
                        if op.param3 not in wait["blacklist"]:
                            random.choice(ABC).kickoutFromGroup(op.param1,[op.param2])
                            random.choice(ABC).inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Zmid])
                    except:
                        pass
            ...
            if mid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ...
                        ki.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid])
                        cl.acceptGroupInvitation(op.param1)
                    except:
                        try:
                            kk.kickoutFromGroup(op.param1,[op.param2])
                            kk.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid])
                            cl.acceptGroupInvitation(op.param1)
                        except:
                            try:
                                kc.kickoutFromGroup(op.param1,[op.param2])
                                kc.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid])
                                cl.acceptGroupInvitation(op.param1)
                            except:
                                try:
                                    kb.kickoutFromGroup(op.param1,[op.param2])
                                    kb.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid])
                                    cl.acceptGroupInvitation(op.param1)
                                except:
                                    try:
                                        kd.kickoutFromGroup(op.param1,[op.param2])
                                        kd.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid])
                                        cl.acceptGroupInvitation(op.param1)     
                                    except:
                                        try:
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        ...
                                                        try:
                                                            ...
                                                            G.preventedJoinByTicket = False   
                                                            kj.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid])     
                                                            cl.acceptGroupInvitation(op.param1)
                                                            ...
                                                            X = kf.getGroup(op.param1)
                                                            X.preventedJoinByTicket = True
                                                            kf.inviteIntoGroup(op.param1,[Imid,Jmid,Zmid])
                                                            wait["blacklist"][op.param2] = True        
                                                        except:
                                                        	pass
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                G.preventedJoinByTicket = True
                                cl.updateGroup(G)
                                random.choice(ABC).inviteIntoGroup(msg.to,[Imid,Jmid,Zmid])

                        elif cmd == "bye":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                random.choice(ABC).cancelGroupInvitation(msg.to,[Imid])
                                random.choice(ABC).cancelGroupInvitation(msg.to,[Jmid])
                                random.choice(ABC).cancelGroupInvitation(msg.to,[Zmid])
